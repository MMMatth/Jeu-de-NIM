...
import classGraphOriente as go
...
fond = pygame.image.load('../img/img_anciene/background.png')
...
zone1 = pygame.image.load("../img/img_anciene/b1.png") #image du bouton
zone1rect = pygame.Rect(10,10,30,30) #rectangle autour de l'image (10,10) coordonnées et (30,30) largeur et hauteur
zone2 = pygame.image.load("../img/img_anciene/b2.png")
zone2rect=pygame.Rect(10,50,30,30)
zone3 = pygame.image.load("../img/img_anciene/b3.png")
...
oui = pygame.image.load("../img/img_anciene/oui.png")
ouirect = pygame.Rect(10,450,50,50)

non = pygame.image.load("../img/img_anciene/non.png")
nonrect = pygame.Rect(70,450,50,50)


#allumettes
nbAllumettes = 12
allumette = pygame.image.load('../img/img_anciene/allumette.png')
...
fondmenu = pygame.image.load("../img/img_anciene/menu.png")
...
while running : # boucle infinie pour laisser la fenêtre ouverte
    if humainVSordi :
            ...
            if nbAllumettes == 1 and player2.joue == True :
                ...
                print(nbAllumettes,tmp)
                G.supprimer_arc(nbAllumettes,nbAllumettes-tmp)
